        ...
        <Card padding="p-2 sm:p-4" className="sticky top-16 z-30 shadow-sm mb-6 border-b-0 rounded-b-none sm:rounded-b-lg sm:border-b transition-all">
            <div className="relative flex items-center w-full" dir="ltr">
                ...
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <Search className="h-6 w-6 text-orange-500 font-bold" />
                </div>
                <input
                    id="search-input"
                    type="text"
                    ...
                    className="block w-full pl-14 pr-12 py-4 sm:py-5 border-2 border-transparent bg-gray-50 rounded-xl leading-5 bg-transparent placeholder-gray-400 focus:outline-none focus:bg-white focus:border-orange-500 focus:ring-4 focus:ring-orange-100 transition-all text-lg sm:text-xl font-medium text-gray-900 shadow-inner"
